...
void main()
{
	...
	//float dist = distance(gl_FragCoord.xy, uLights[0].xy);
	//float att = 1.0 / (1 + distance(gl_FragCoord.xy, uLights[0].xy) * 0.01);
	...
	//FragColor = vec4(texColor.xyz * att, texColor.w) * fColor;
